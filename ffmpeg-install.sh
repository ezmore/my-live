...
export PATH
#=================================================================#
#   System Required: CentOS7 Ubuntu X86_64                        #
#   Description: FFmpeg Stream Media Server                       #
#   Author: LALA,Student:FormID                                   #
#   Website: https://wp.ezmore.xyz                                #
#=================================================================#
...
ffm(){
    read -p "请输入数字(1-3),1for安装，2for运行，3for停止，选择你要进行的操作:" num
    case "$num" in
        1)
        ffmpeg_install
        ;;
